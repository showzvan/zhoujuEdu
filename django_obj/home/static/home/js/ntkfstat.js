...
var CON_RULE = {};
var CON_SERVER = {
    flashserver: 'http://bj-kf10225.ntalker.com/downt/t2d/',
...
! function(window, underfined) {
    ...
    nTalk.fn = nTalk.prototype = {
        ...
        var e, t, n, r, i, o = arguments[0] || {},
            ...
            s = arguments.length,
            l = !1;
        for ("boolean" == typeof o && (l = o, o = arguments[1] || {}, a = 2), "object" == typeof o || nTalk.isFunction(o) || (o = {}), s === a && (o = this, --a); a < s; a++)
            if (e = arguments[a])
                for (var c in e) e.hasOwnProperty(c) && (t = o[c], o !== (n = e[c]) && (l && n && (nTalk.isPlainObject(n) || (r = nTalk.isArray(n))) ? (r ? (r = !1, i = t && nTalk.isArray(t) ? t : []) : i = t && nTalk.isPlainObject(t) ? t : {}, o[c] = nTalk.extend(l, i, n)) : n !== undefined && (o[c] = n)));
        return o
    }, nTalk.extend({
        ...
        merge: function() {
            var e, t, n, r = arguments[0] || {},
                i = arguments;
            if (i.length <= 1) return r;
            for (e = 1; e < i.length; e++)
                if (i[e] && null !== i[e])
                    if (i[e].length === undefined)
                        for (t in i[e]) i[e].hasOwnProperty(t) && (r[t] = i[e][t]);
                    else
                        for (t = 0, n = i[e].length; t < n; t++) r.length !== undefined ? r.push(i[e][t]) : r[t] = i[e][t];
            return r
        },
        each: function(e, t, n) {
            if (nTalk.isArray(n) || (n = []), nTalk.isArray(e) || nTalk.isObject(e) && e.talkVersion)
                for (var r = 0; r < e.length && !1 !== t.apply(e[r], [r, e[r++]].concat(n)););
            else if (nTalk.isObject(e))
                for (var i in e) e.hasOwnProperty(i) && t.apply(e[i], [i, e[i]].concat(n));
            else t.apply(e, [0, e].concat(n));
            return e
        },
        ...
        queryRelative: {
            ...
            ">": function(e, t) {
                for (var n, r = [], i = e.length, o = 0; o < i; o++)
                    for (n = e[o].firstChild; n;) 1 === n.nodeType && (n.nodeName.toLowerCase() !== t && "*" !== t || r.push(n)), n = n.nextSibling;
                return r
            },
            "+": function(e, t) {
                for (var n, r = [], i = e.length, o = 0; o < i; o++)
                    for (n = e[o]; n = n.nextSibling;)
                        if (1 === n.nodeType) {
        ...
        initializeCore: function() {
            var e = /([^\.]+(\.com(\.cn)?|\.net(\.cn)?|\.edu(\.cn)?|\.org(\.cn)?|\.gov(\.cn)?|\.cn|\.mobi|\.tel|\.asia|\.me|\.info|\.hk|\.cc|\.biz|\.tv))$/i.exec(document.domain),
                ...
                n = "";
            root = nTalk(document);
            var r = nTalk("script[src*=ntkf]"),
                i = nTalk("script[src*=base.out]"),
                o = [];
        ...
        ready: function(e) {
            var t = this,
                ...
                r = nTalk.browser.webkit && nTalk.browser.version < 525,
                i = function() {
                    if (!readyComplete) {
            ...
            else if (document.addEventListener) "interactive" == n ? i() : (document.addEventListener("DOMContentLoaded", i, !1), window.addEventListener("load", i, !1));
            else {
        ...
        require: function(e, t, n) {
            ...
            e && (e = "string" == typeof e ? [e] : e, t = t || emptyFunc, n = n || document.head || nTalk("head")[0] || document.documentElement, i = nTalk._getObjectNumber(e), 0 === a.length && 0 === i && t.apply(l, s), nTalk.each(e, function(e, c) {
                if (c) {
                    var u, h = nTalk.getTime(),
                        f = -1 == c.indexOf("?") ? "?" : "&",
                        d = c.replace(/(.*\/)?(.*?)[\?$](.*)?/i, "$2"),
                        p = nTalk.isNumeric(e) ? "" : e,
                        g = function() {
                        ...
                        T = function(e) {
                            var t = (e = nTalk.Event.fixEvent(e)).currentTarget || e.srcElement,
                                n = t.readyState;
        ...
        return window.addEventListener ? (o = function(e, n, r, i) {
            ...
            var i = "{FNKEY::obj_" + e(t) + "::evt_" + n + "::fn_" + r + "}",
                o = s[i];
            ...
            switch ("function" == typeof rep && (l = rep.call(t, e, l)), typeof l) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep)
                        for (o = rep.length, n = 0; n < o; n += 1) "string" == typeof(r = rep[n]) && (i = str(r, l)) && a.push(quote(r) + (gap ? ": " : ":") + i);
                    else
                        for (r in l) l.hasOwnProperty(r) && (i = str(r, l)) && a.push(quote(r) + (gap ? ": " : ":") + i);
                    return i = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + s + "}" : "{" + a.join(",") + "}", gap = s, i
            }
        }
        ...
        return toJSONString = function(e, t) {
            ...
            function walk(e, t) {
                ...
                if (r && "object" == typeof r)
                    for (var i in r) r.hasOwnProperty(i) && ((n = walk(r, i)) !== undefined ? r[i] = n : delete r[i]);
        ...
        first: function() {
            for (var e in this.hashTable)
                if (this.hashTable.hasOwnProperty(e)) return this.hashTable[e]
        },
        last: function() {
            var e = null;
        ...
        previous: function(e) {
            var t = null;
            for (var n in this.hashTable)
                if (this.hashTable.hasOwnProperty(n)) {
                    if (n == e) return t;
                    t = n
                }
            return t
        ...
        next: function(e) {
            ...
            for (var r in this.hashTable)
                if (this.hashTable.hasOwnProperty(r))
                    if (t || (t = r), r != e) {
                        if (n) return r
                    } else n = !0;
            return t
        ...
        index: function(e) {
            for (var t = 0; t < this.hashIndex.length; t++)
                if (this.hashIndex[t] == e) return t;
            return !1
        },
        contains: function(e) {
        ...
        form: function(e, t) {
            ...
            if (n = nTalk({
                ...
                target: this.target,
                action: e
            }).appendTo(this.hiddenElement), nTalk.isArray(t))
                for (var r = 0; r < t.length; r++)
                    for (var i in t[r]) t[r].hasOwnProperty(i) && this.input(i + "[]", t[r][i], n);
            else
                for (var o in t)
                    if (t.hasOwnProperty(o))
                        if (nTalk.isArray(t[o]))
                            for (var a = 0; a < t[o].length; a++) this.input(o + "[]", t[o][a], n);
                        else this.input(o, t[o], n); return n.get(0)
        },
        ...
        uriToJSON: function(e) {
            for (var t, n = {}, r = e.toString().split("&"), i = 0; i < r.length; i++)
                if (!((t = r[i].split("=")).length < 2)) try {
        ...
        whereGet: function(e, t, n, r) {
            var i = {};
            if (t && nTalk.isArray(t))
                for (var o = 0, a = t.length; o < a; o++) n && n[o] && n[o] !== t[o] ? i[n[o]] = nTalk.isDefined(e[t[o]]) ? e[t[o]] : "" : i[t[o]] = nTalk.isDefined(e[t[o]]) ? e[t[o]] : "";
            else i = e; if (!nTalk.isFunction(r)) return i;
        ...
        hexToDec: function(e) {
            if (!e) return "";
            var t = e.match(/\\u([0-9a-zA-Z]{2,4})|&#(\d+);/gi),
                n = e;
            if (!t) return n;
            for (var r = 0; r <= t.length; r++)
                if (t[r]) {
        ...
        _vendorPropName: function(e, t) {
            if (t in e) return t;
            for (var n = ["Webkit", "O", "Moz", "ms"], r = t.charAt(0).toUpperCase() + t.slice(1), i = t, o = n.length; o--;)
                if ((t = n[o] + r) in e) return t;
            return i
        },
        css: function(e, t, n) {
            var r;
            ...
            select: {
                get: function(e) {
                    ...
                    for (n = l ? o : 0, r = l ? o + 1 : s.length; n < r; n++)
                        if ((i = s[n]).selected && null === i.getAttribute("disabled") && !i.parentNode.disabled && "OPTGROUP" !== i.parentNode.tagName.toUpperCase()) {
        ...
        replace: function(e) {
            return nTalk.each(this, function(t, n) {
                if (n.replaceNode) n.replaceNode(e);
                else try {
        ...
        remove: function() {
            return nTalk.each(this, function(e, t) {
                var n = !1;
                for (var r in t)
                    if ("IFRAME" != t.tagName.toUpperCase()) try {
        ...
        val: function(e) {
            ...
            if ((t = nTalk.valHooks[i.type]) && "get" in t) {
                ...
                for (var o = [], a = 0; a < this.length; a++)
                    if ((n = t.get(this[a], "value")) !== undefined && this[a].checked) {
                        if (r) return n;
                        o.push(n)
                    }
                return r ? "" : o
        ...
        setOffset: function(e, t) {
            var n, r, i, o = nTalk.css(e, "position"),
                a = nTalk(e),
                s = {};
        ...
        deserialize: function(e) {
            if (!e) return {};
            var t, n = /"/.test(e) ? e : e.replace(/(\{|\[)/g, '$1"').replace(/(}|])/g, '"$1').replace(/(:|,)/g, '"$1"');
            try {
        ...
        formatData: function(e, t) {
            for (var n, r = e.split("."), i = nTalk.cache.data; n = r.shift();)
                if (r.length > 0) i[n] || (i[n] = {}), i = i[n];
                else {
    ...
    nTalk.doAjaxRequest = function(t) {
        ...
        1: [
            function(e, t, n) {
                ...
                var f = e("cssfilter").FilterCSS,
                    d = e("cssfilter").getDefaultWhiteList,
                    p = e("./util"),
                    g = new f,
                    m = /</g,
                    T = />/g,
                ...
                n.whiteList = {
                    ...
                    ul: [],
                    video: ["autoplay", "controls", "loop", "preload", "src", "height", "width"]
                }, n.getDefaultWhiteList = r, n.onTag = function(e, t, n) {}, n.onIgnoreTag = function(e, t, n) {}, n.onTagAttr = function(e, t, n) {}, n.onIgnoreTagAttr = function(e, t, n) {}, n.safeAttrValue = function(e, t, n, r) {
        ...
        7: [
            function(e, t, n) {
                ...
                n.whiteList = r(), n.getDefaultWhiteList = r, n.onAttr = function(e, t, n) {}, n.onIgnoreAttr = function(e, t, n) {}
            }, {}
        ],
        8: [
            function(e, t, n) {
...
/* @file flashserver
 * @date 2018.10.15 17:14:13
 */
(function($) {
    $.flashserver = {
        'trailserver': 'http://bj-10225.ntalker.com/trail/trail',
        'presenceserver': 'rtmp://10.1.62.36:80/flashIM',
        'presencegoserver': 'http://bj-10225.ntalker.com/flashIM/wdkstatus',
        'crmcenter': '',
        'mcenter': 'http://bj-10225.ntalker.com/record/mcenters/',
        'coopserver': '',
        'roboturl': '',
        't2dstatus': 'http://bj-10225.ntalker.com/t2d1/t2dstatus',
        'chatview_in': '',
        'chatview_out': '',
        'chatview_wap': '',
        'queryurl': 'http://bj-10225.ntalker.com/spider/spider/',
        'tchatmqttserver': 'tcp://bj-10225.ntalker.com:7080/tchat1;ws://bj-10225.ntalker.com:7081/tchat1;wss://bj-10225.ntalker.com:7082/tchat1',
        'eduimmqttserver': '',
        'robotserver': 'http://bj-10225.ntalker.com/assist',
        'kpiserver': 'http://bj-10225.ntalker.com/kpi',
        'xpushim': 'ws://bj-10225.ntalker.com:7085/NEWIM;wss://bj-10225.ntalker.com:7086/NEWIM',
        'xpushthirdpush': 'http://bj-10225.ntalker.com/xpush/thirdpush',
        'isnoim': 2,
        'notrail': 0,
        'preload': 2000,
        'sessioncarry': '1',
        ...
        'xpushpolltimeout': '15',
        'usexpush': '0',
        'settingserver': 'http://bj-kf10225.ntalker.com/setting',
        'apiserver': 'http://bj-kf10225.ntalker.com/api/',
        'siteid': 'kf_10225'
    };
...
! function(e, l) {
    e.trail || (e.trail = {
        ...
        start: function(l, t, i, r) {
            var a, o, n = this,
                s = e.referrer && e.referrer.indexOf(e.domain) > -1;
            this.called && !t || (e.Log("nTalk.trail.start()", 1), this.etype = t ? "update" : this.etype, this.useSdkData = i, l || "" === e.global.trailid || !s ? this.islogin = 1 : this.islogin = 0, a = this.formartData(), !e.isEmptyObject(e.global.ntalkerparam) && e.global.ntalkerparam && (o = e.extend({}, {
                ntalkerparam: e.global.ntalkerparam
            })), o = e.extend(o, {
                ref: document.referrer
            }), e.each(a, function(l, t) {
    ...
    if (e.baseURI && !e.base) {
        if (e.extend({
            ...
            startData: function(t, a) {
                var i = this;
                e.Log("nTalk.base.startData()"), e.require({
                    data: "data.js" + e.baseExt
                }, function(o) {
                    if (o) {
            ...
            startChat: function(t, a, i, o, n, r, l, s, d, g) {
                var c;
                t = t || "", a = a || "", i = i || "", o = o || "", n = n || "", d = d || "", g = g || "", e.im && e.im.hideTips(), !0 !== e.base.chatLoading ? (e.Log("$.base.startChat(" + e.JSON.toJSONString(arguments) + ")", 1), e.base.showLoading(), c = {
                    lang: (e.extParmas.lan || "zh_cn") + ".js" + e.baseExt
                }, e.browser.supportMqtt && e.server.tchatmqttserver && 1 == e.server.tchatConnectType ? (c.MQTT = "mqtt31.js" + e.baseExt, c.Connection = "mqtt.chat.js" + e.baseExt) : e.flash.support && e.server.tchatmqttserver && 1 == e.server.tchatConnectType ? (c.MQTT = "flashsock.js" + e.baseExt, c.Connection = "mqtt.chat.js" + e.baseExt) : c.TChat = "comet.chat.js" + e.baseExt, e.global.themes ? (c.chatManage = "chat.js" + e.baseExt, c.chatManageView = e.global.themes + "/chat.view.in.js" + e.baseExt, e.themesURI = e.global.themes + "/images/") : e.mobileOpenInChat && e.browser.mobile ? c.chatManage = "chat.js" + e.baseExt : c.chatManage = "chat.in.js" + e.baseExt, c.Window = "nt2.js" + e.baseExt, 1 == e.server.robot && (c.Robot = "robot.js" + e.baseExt), e.require(c, function() {
            ...
            startEntrance: function() {
                ...
                e.Log("$.base.startEntrance()"), t && e.server.entranceConfig && !e.isEmptyObject(e.server.entranceConfig) && e.require({
                    entrance: t + e.baseExt
                }, function(t) {
            ...
            startOtherMode: function(t, a) {
                ...
                if (o = window.localStorage.carry_dest ? e.JSON.parseJSON(window.localStorage.carry_dest) : "", "0" != e.server.sessioncarry && o && !e.browser.mobile) {
                    if (e.Log("sessioncarry:" + e.JSON.toJSONString(o)), window.localStorage.carry_dest = "", o)
                        for (k in o)
                            if (k) {
                                if (k.indexOf("ISME9754") > -1) return;
                                e.browser.mobile || !e.global.pageinchat ? (i = {
                                    single: -1
                                }, e.im_openOutPageChat(k, "", o[k], i, "")) : (i = {
                                    autoconnect: !0,
                                    single: -1
            ...
            _loadIdentityID: function(t) {
                ...
                }, this.timeOut)) : e.cookie.enable() ? (o = this._createScriptPCID(!1), e.Log("create script PCID"), a = e.global.uid || this.userIdFix + o.substr(0, 21), t.call(this, a, o), n(a, o)) : e.require({
                    Fingerprint2: "fingerprint2.js" + e.baseExt
                }, function(r) {
                ...
                }), e.isAutoEdu && e.require({
                    auto: "auto.js" + e.baseExt
                }, function() {})
            },
            ...
            _createMobileOpenInPageWindow: function(t) {
                ...
                if (a.length) return t || e._showMobileInPageWindow(), {
                    created: !1,
                    element: a
                };
                var i = 1;
            ...
            _createMobileIframeWindow: function(t) {
                var a = e(".ntalk-mobile-iframe-window"),
                    i = e("IFRAME[name=" + t + "]");
                return a.length ? {
                    created: !1,
                    element: a
            ...
            im_openInPageChat: function(t, a, i, o, n) {
                var r, l, s, d;
                if (!e.base._startBase) return e.base.start(), void
                function() {
                ...
                if (e.base.chanageUserID()) e.base.overloadedData(function() {
                    ...
                    var g = o && o.single ? o.single : "",
                        c = o && o.manual ? 1 : 0,
                        b = !(!o || !e.isDefined(o.autoconnect)) && o.autoconnect,
                        u = o && o.edu_inviteid ? o.edu_inviteid : "",
                        h = o && o.edu_visitid ? o.edu_visitid : "";
            ...
            im_openOutPageChat: function(t, a, i, o, n) {
                ...
                function() {
                    ...
                    if (!e.base.chanageUserID()) {
                        ...
                        var g, c = e.browser.mobile ? "_self" : "_blank",
                            b = o && o.single ? o.single : "",
                            u = (o && o.manual, {
                                v: e.version.script,
                                siteid: e.global.siteid,
                                sellerid: d,
                        ...
                        return e.global.themes && (u.themes = e.global.themes), o.iframechat ? (c = "ntalk-mobile-chat", e.browser.mobile && e.chatViewport && e.chatViewport(), e.require({
                            animate: "nt2.js" + e.baseExt
                        }, function(a) {
        ...
        e.imageloading = e.sourceURI + "images/loading.gif", e.server = e.extend({}, e.protocolFilter(CON_SERVER)), e.version = e.extend({}, e.version, CON_VERSION), e.baseExt = "?siteid=" + (e.extParmas.siteid || "") + "&v=" + e.version.dir + "&t=" + e.version.release, parseFloat(e.params["ntalker-debug"]) > 0 || +e.cache.get("debug") > 0 ? e.require({
        ...
        }) : (e.Log = function() {}, e.debug = {
            Log: e.Log
        }, e.base.start()), e._showMobileInPageWindow = function() {
            e("html").addClass("full-html"), e("body").addClass("full-inpage"), e("body").css("padding") && (e.rememberBodyPadding = e("body").css("padding"), e("body").css({
                padding: 0
            })), e(".ntalk-mobile-inpage-background").css({
                "z-index": 999999999,
                display: "block",
            ...
            e.rememberBodyPadding && e("body").css({
                padding: e.rememberBodyPadding
            }), e("html").removeClass("full-html"), e("body").removeClass("full-inpage"), e(".ntalk-mobile-inpage-background").css({
                "z-index": -1,
                display: "none"
            ...
            e.rememberBodyPadding && e("body").css({
                padding: e.rememberBodyPadding
            }), e("html").removeClass("full-html"), e("body").removeClass("full-inpage"), e("#ntalk-chat-loading").length > 0 && e("#ntalk-chat-loading").remove(), e(".ntalk-mobile-inpage-background").remove(), e(".nTalk-window-offLine").css("display", "none")
